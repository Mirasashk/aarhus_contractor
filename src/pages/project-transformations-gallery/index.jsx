...
const ProjectTransformationsGallery = () => {
  const [projects] = useState([
    {
      ...
      award: true,
      completedYear: 2024,
      description: "A thoughtful restoration of a 1920s kitchen that honors original Danish craftsmanship while introducing modern functionality.",
      ...
      processSteps: [
        { title: "Heritage Assessment", description: "Detailed analysis of original features and materials", duration: "1 week" },
        { title: "Design Development", description: "Creating plans that honor the home's history", duration: "2 weeks" },
        { title: "Material Sourcing", description: "Finding period-appropriate materials and finishes", duration: "3 weeks" },
        { title: "Restoration Work", description: "Careful restoration of original elements", duration: "6 weeks" },
        { title: "Modern Integration", description: "Installing contemporary systems seamlessly", duration: "4 weeks" }
      ],
      materials: [
        { category: "Flooring", description: "Restored original oak planks", quality: "Heritage Grade" },
        { category: "Cabinetry", description: "Solid oak with traditional joinery", quality: "Master Crafted" },
        { category: "Countertops", description: "Carrara marble with honed finish", quality: "Premium Natural" },
        { category: "Hardware", description: "Hand-forged brass fittings", quality: "Artisan Made" }
      ]
    },
    {
      id: 2,
      ...
      award: false,
      completedYear: 2024,
      description: "A serene bathroom transformation emphasizing clean lines, natural materials, and Danish hygge principles.",
      ...
      processSteps: [
        { title: "Space Planning", description: "Optimizing layout for maximum impact", duration: "3 days" },
        { title: "Plumbing Updates", description: "Installing new systems for modern fixtures", duration: "1 week" },
        { title: "Waterproofing", description: "Comprehensive moisture protection", duration: "3 days" },
        { title: "Tiling & Finishes", description: "Precision installation of premium materials", duration: "2 weeks" },
        { title: "Fixture Installation", description: "Final fitting and testing of all systems", duration: "1 week" }
      ],
      materials: [
        { category: "Tiles", description: "Large format porcelain in warm white", quality: "Premium Grade" },
        { category: "Vanity", description: "Solid oak with integrated basin", quality: "Custom Made" },
        { category: "Fixtures", description: "Matte black premium fittings", quality: "Designer Series" },
        { category: "Lighting", description: "LED strips with dimming control", quality: "Smart Technology" }
      ]
    },
    {
      id: 3,
      ...
      award: true,
      completedYear: 2024,
      description: "An open-plan living area that perfectly captures the Danish concept of hygge through thoughtful design and natural materials.",
      ...
      processSteps: [
        { title: "Structural Assessment", description: "Evaluating walls for safe removal", duration: "1 week" },
        { title: "Demolition", description: "Careful removal of non-structural elements", duration: "1 week" },
        { title: "Systems Installation", description: "Updating electrical, heating, and lighting", duration: "3 weeks" },
        { title: "Flooring & Finishes", description: "Installing premium materials throughout", duration: "4 weeks" },
        { title: "Built-in Elements", description: "Custom carpentry and final details", duration: "6 weeks" }
      ],
      materials: [
        { category: "Flooring", description: "Wide-plank European oak", quality: "Premium Select" },
        { category: "Built-ins", description: "Custom oak cabinetry and shelving", quality: "Master Crafted" },
        { category: "Textiles", description: "Natural wool and linen fabrics", quality: "Sustainable Luxury" },
        { category: "Lighting", description: "Designer pendant and accent lighting", quality: "Architectural Grade" }
      ]
    },
    {
      id: 4,
      ...
      award: false,
      completedYear: 2024,
      description: "A peaceful bedroom design that combines modern functionality with classic Danish design principles.",
      ...
      processSteps: [
        { title: "Design Planning", description: "Creating optimal layout for rest and storage", duration: "1 week" },
        { title: "Electrical Work", description: "Installing smart lighting and controls", duration: "3 days" },
        { title: "Custom Carpentry", description: "Building integrated storage solutions", duration: "2 weeks" },
        { title: "Finishes", description: "Painting, flooring, and detail work", duration: "1 week" },
        { title: "Final Styling", description: "Completing the space with textiles and accessories", duration: "3 days" }
      ],
      materials: [
        { category: "Wardrobes", description: "White oak with soft-close mechanisms", quality: "Premium Hardware" },
        { category: "Flooring", description: "Engineered oak planks", quality: "Commercial Grade" },
        { category: "Textiles", description: "Organic cotton and linen bedding", quality: "Luxury Comfort" },
        { category: "Lighting", description: "Adjustable LED system", quality: "Smart Technology" }
      ]
    },
    {
      id: 5,
      ...
      award: true,
      completedYear: 2023,
      description: "A complete transformation of a former textile factory into a stunning modern loft while preserving industrial character.",
      ...
      processSteps: [
        { title: "Structural Engineering", description: "Assessing and reinforcing the building structure", duration: "3 weeks" },
        { title: "Heritage Consultation", description: "Working with preservation specialists", duration: "2 weeks" },
        { title: "Systems Installation", description: "Modern plumbing, electrical, and HVAC", duration: "8 weeks" },
        { title: "Restoration Work", description: "Cleaning and preserving original elements", duration: "6 weeks" },
        { title: "Modern Additions", description: "New construction within existing shell", duration: "12 weeks" }
      ],
      materials: [
        { category: "Flooring", description: "Polished concrete with radiant heating", quality: "Industrial Premium" },
        { category: "Windows", description: "Restored steel factory windows", quality: "Heritage Restoration" },
        { category: "Fixtures", description: "Vintage industrial lighting", quality: "Authentic Period" },
        { category: "Finishes", description: "Raw steel and reclaimed wood", quality: "Sustainable Reclaimed" }
      ]
    },
    {
      id: 6,
      ...
      award: false,
      completedYear: 2023,
      description: "A complete kitchen renovation that honors traditional Danish farmhouse design while incorporating modern conveniences.",
      ...
      processSteps: [
        { title: "Historical Research", description: "Studying original farmhouse kitchen designs", duration: "2 weeks" },
        { title: "Material Sourcing", description: "Finding authentic reclaimed materials", duration: "4 weeks" },
        { title: "Structural Work", description: "Reinforcing floors and walls", duration: "2 weeks" },
        { title: "Traditional Carpentry", description: "Hand-building cabinetry using period techniques", duration: "6 weeks" },
        { title: "Finishing Work", description: "Traditional painting and detailing", duration: "2 weeks" }
      ],
      materials: [
        { category: "Cabinetry", description: "Reclaimed pine with traditional joinery", quality: "Heritage Authentic" },
        { category: "Countertops", description: "Thick butcher block oak", quality: "Traditional Craft" },
        { category: "Tiles", description: "Hand-made ceramic in traditional patterns", quality: "Artisan Made" },
        { category: "Hardware", description: "Forged iron handles and hinges", quality: "Period Reproduction" }
      ]
    }
  ]);
  ...
  const filteredProjects = projects?.filter(project => {
    // Space type filter
    if (filters?.spaceType !== 'all' && project?.type?.toLowerCase() !== filters?.spaceType) {
      return false;
    }

    // Style filter
    if (filters?.style !== 'all' && project?.style?.toLowerCase()?.replace(' ', '-') !== filters?.style) {
      return false;
    }

    // Investment filter
    if (filters?.investment !== 'all') {
      const [min, max] = filters?.investment?.split('-')?.map(v => v === '+' ? Infinity : parseInt(v));
      const projectAvg = (project?.investment?.min + project?.investment?.max) / 2;
      if (max) {
    ...
    if (filters?.timeline !== 'all') {
      const timelineMap = {
        ...
        '6+': ['6 months', '7 months', '8 months', '9 months', '10 months']
      };
      
      const allowedTimelines = timelineMap?.[filters?.timeline] || [];
      if (!allowedTimelines?.some(timeline => project?.timeline?.includes(timeline?.split(' ')?.[0]))) {
        return false;
      }
    }
  ...
  const sortedProjects = [...filteredProjects]?.sort((a, b) => {
    switch (sortBy) {
      ...
      case 'investment-high':
        return ((b?.investment?.min + b?.investment?.max) / 2) - ((a?.investment?.min + a?.investment?.max) / 2);
      case 'investment-low':
        return ((a?.investment?.min + a?.investment?.max) / 2) - ((b?.investment?.min + b?.investment?.max) / 2);
      default:
        return 0;
    }
  });
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="body-primary text-xl text-muted-foreground mb-8 leading-relaxed">
              Discover how thoughtful Danish craftsmanship transforms spaces into sanctuaries. 
              Each project tells a story of heritage, innovation, and the pursuit of hygge through design.
            </p>
      ...
      <section className="bg-muted py-16">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="body-primary text-lg text-muted-foreground mb-8 leading-relaxed">
            Every great transformation begins with a conversation. Let's discuss your vision 
            and explore how Danish craftsmanship can bring your dream space to life.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <h3 className="text-lg font-semibold text-foreground mb-4">Aarhus Contractor</h3>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                Transforming Danish homes through thoughtful craftsmanship and timeless design principles. 
                Every project is a partnership in creating spaces that enhance daily life.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="/service-specializations" className="hover:text-foreground transition-colors">Kitchen Renovation</a></li>
                <li><a href="/service-specializations" className="hover:text-foreground transition-colors">Bathroom Design</a></li>
                <li><a href="/service-specializations" className="hover:text-foreground transition-colors">Living Spaces</a></li>
                <li><a href="/service-specializations" className="hover:text-foreground transition-colors">Heritage Restoration</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>+45 8765 4321</li>
                <li>hello@aarhuscontractor.dk</li>
                <li>Aarhus, Denmark</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; {new Date()?.getFullYear()} Aarhus Contractor. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
