...
const AboutOurCraft = () => {
	useEffect(() => {
		// Set page title
		document.title =
			'About Our Craft - Aarhus Contractor | Danish Heritage & Modern Expertise';
		...
		if (metaDescription) {
			metaDescription?.setAttribute(
				'content',
				'Discover the story behind Aarhus Contractor - from traditional Danish carpentry apprenticeship to contemporary renovation mastery. Meet our team of craftspeople who blend cultural heritage with modern expertise.'
			);
		}
