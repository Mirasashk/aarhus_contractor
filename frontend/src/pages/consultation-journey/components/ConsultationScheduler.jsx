	...
	const consultationTypes = [
		{
			...
			icon: 'ClipboardList',
			description:
				'Kickoff discussion on project scope, compliance, risks, and feasibility',
			benefits: [
				'Scope alignment',
				'Compliance review',
				'Risk identification',
		...
		},
		{
			...
			icon: 'FileText',
			description:
				'Walkthrough of detailed proposal with budget, timeline, and deliverables',
			benefits: [
				'Cost breakdown',
				'Timeline plan',
				'Milestones',
		...
		},
		{
			...
			icon: 'Handshake',
			description:
				'Terms, compliance requirements, warranties, and performance metrics',
			benefits: [
				'Terms & conditions',
				'Compliance clauses',
				'Warranty terms',
		...
		},
		{
			...
			icon: 'PlayCircle',
			description:
				'Team introductions, governance, reporting cadence, and stakeholder mapping',
			benefits: [
				'Team alignment',
				'Governance model',
				'Reporting cadence',
		...
		<div className='space-y-8'>
			...
			<div className='text-center'>
				...
				<p className='body-secondary text-muted-foreground max-w-2xl mx-auto'>
					Choose the meeting type that best matches your stage:
					assessment, proposal, negotiation, or kickoff.
				</p>
			</div>
						...
						<div
							...
							className={`p-6 rounded-lg border-2 cursor-pointer transition-all duration-fast gentle-hover ${
								selectedType === type?.id
									...
									: 'border-border bg-card hover:border-muted-foreground hover:shadow-card'
							}`}
						>
